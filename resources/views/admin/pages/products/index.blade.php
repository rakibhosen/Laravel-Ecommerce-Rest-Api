              ...
              <div class="col-6">
                <div class="card card-primary card-outline">
                  <div class="card-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                      <li class="list-group-item">
                        <b>Size</b> <a class="float-right">{{ $product->product_size }}</a>
                      </li>
                      <li class="list-group-item">
                        <b>Quantity</b> <a class="float-right">{{ $product->product_quantity }}</a>
                      </li>
                      <li class="list-group-item">
                        <b>Color</b> <a class="float-right">{{ $product->product_color }}</a>
                      </li>
                          ...
                          <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" id="inputName" class="form-control form-control-sm shadow bg-white rounded-0" name="color" value="{{ $product->product_color }}">
                                  </div>
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" id="inputName" class="form-control form-control-sm shadow bg-white rounded-0" name="size" value="{{ $product->product_size }}">
                                  </div>
                ...
                <div class="card-body">
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <label for="inputName">Color</label>
                                <input type="text" id="inputName" class="form-control form-control-sm shadow bg-white rounded-0" name="color">
                              </div>
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <label for="inputName">Size</label>
                                <input type="text" id="inputName" class="form-control form-control-sm shadow bg-white rounded-0" name="size">
                              </div>
